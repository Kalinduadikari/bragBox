...
const ToggleButton = styled.div`
  ...
  padding: 0;
  position: relative; /* Add this line to ensure the pseudo-element is correctly positioned */
  ...
  /* Add a pseudo-element to create a transparent overlay on hover */
  &::before {
    content: "";
    position: absolute;
    top: 0;
  ...
  &:hover::before {
    opacity: 1; /* Show the transparent overlay on hover */
    transform: scale(1); /* Scale the overlay */
